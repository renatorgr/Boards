...
void autosteerLoop()
{
	...
	{
		if (speedPulseUpdateTimer > 200) // 100 (10 Hz) seems to cause tone lock ups occasionally
		{
			speedPulseUpdateTimer = 0;

			//130 pp meter, 3.6 kmh = 1 m/sec = 130 Hz or gpsSpeed * 130/3.6 or gpsSpeed * 36.1111
